...
export const Home = () => {
  ...
  return (
    <div id='home' className={styles.homes}>
     ...
     <FadeText
        text="Hi, I'm"
        className="font-display text-6xl md:text-7xl md:p-3 font-semibold"
        direction="left"
      />
      <br />
      <FadeText
        text="Gaurav Sharma"
        className="font-display text-6xl md:text-8xl font-bold leading-[10rem] tracking-[-0.02em] drop-shadow-sm mt-4"
        direction="left"
      />
